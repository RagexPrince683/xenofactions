...
public final class BuilderPlan {
    ...
    public NBTTagCompound write(){NBTTagCompound n=new NBTTagCompound();n.setString("Source",source);n.setString("Schematic",schematicId);n.setString("Name",displayName);n.setString("Validation",validationKey);n.setInteger("X",originX);n.setInteger("Y",originY);n.setInteger("Z",originZ);n.setByte("Rotation",(byte)(rotation&3));n.setBoolean("Mirrored",mirrored);n.setBoolean("Preview",preview);return n;}
    public void read(NBTTagCompound n){source=n.getString("Source");schematicId=n.getString("Schematic");displayName=n.getString("Name");validationKey=n.getString("Validation");originX=n.getInteger("X");originY=n.getInteger("Y");originZ=n.getInteger("Z");rotation=n.getByte("Rotation")&3;mirrored=n.getBoolean("Mirrored");preview=n.getBoolean("Preview");}
}
