...
public final class BuilderJobData extends WorldSavedData {
	...
	public static BuilderJobData get(World world){
		if(world==null||world.isRemote)return null;
		WorldServer root=DimensionManager.getWorld(0);
		if(root==null)return null;
		BuilderJobData d=(BuilderJobData)root.perWorldStorage.loadData(BuilderJobData.class,ID);
		if(d==null){d=new BuilderJobData();root.perWorldStorage.setData(ID,d);}
		return d;
	}
