...
public final class BuilderJob {
	...
	public int targetX,targetY,targetZ,workX,workY,workZ,schematicX,schematicY,schematicZ,requiredMeta,missingQuantity,pathFailures,waitingChunkX,waitingChunkZ,unsupportedMeta;
