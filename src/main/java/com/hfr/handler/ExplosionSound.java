...
public class ExplosionSound {
	...
	public static void handleExplosion(World world, Explosion explosion) {
		...
		boolean isMCHeliExplosion = isMCHeliExplosion(explosion);

		if(isMCHeliExplosion && !isMCHeliExplosionSoundEnabled(explosion))
			return;

		handleExplosion(world, explosion.explosionX, explosion.explosionY, explosion.explosionZ, explosion.explosionSize, !isMCHeliExplosion);
	}
	...
	public static void handleMCHeliExplosion(World world, Explosion explosion) {
		...
		if(!isMCHeliExplosion(explosion))
			return;
	...
	private static boolean isMCHeliExplosion(Explosion explosion) {
		return explosion != null && MCHELI_EXPLOSION_CLASS.equals(explosion.getClass().getName());
	}
