...
public class GUIFlag extends GuiContainer {
	...
	protected void drawGuiContainerForegroundLayer(int x, int y) {
		...
		this.fontRendererObj.drawString("Level: " + diFurnace.cityLevel.level() + " Radius: " + diFurnace.cityLevel.radius + " Upkeep: " + Clowder.round(diFurnace.cityLevel.upkeep), 50, 42, 0xFFFFFF);
