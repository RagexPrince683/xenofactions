...
* **Developed production/prestige support:** Coal Mine, Production Line (`machine_factory`), University, Federal Reserve, Temple, and Statue. These have operational multiblocks/tile entities, player-facing lore or NEI processing information, and active outputs or prestige effects.
...
| Federal Reserve | `GEG / SCS / ODO` | G gold block, E electronic component, S steel component, C chest, O obsidian, D diamond | Valuable passive prestige/storage infrastructure receives the highest liquid-wealth cost. |
...
* **Decorative/building blocks:** mud, rope, temporary/foundation/asphalt blocks, Wall Art, HESCO/palisade/wall variants, Berlin wall, and similar props are decorative, generated, independently sourced, or outside the core faction loop. Existing recipes (for example barricades) remain untouched.
